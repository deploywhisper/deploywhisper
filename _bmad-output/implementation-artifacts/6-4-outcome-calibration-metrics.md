...
- [x] [Review][Patch] Keep the history page workspace filter consistent by scoping risk trends with the selected workspace alongside history rows and calibration. [frontend/src/screens/history.py:370]
...
- [x] [Review][Patch] Re-render history risk-trend and calibration summary cards after workspace/filter changes. [frontend/src/screens/history.py:589]
- [x] [Review][Patch] Surface active feedback-bias limitations instead of displaying only the first calibration limitation. [frontend/src/screens/history.py:257]
...
- [x] [Review][Patch] Run and record local app startup/manual sanity validation for the changed history calibration UI flow. [frontend/src/screens/history.py:160]
...
- [x] [Review][Patch] Make the empty history calibration seed mirror the full calibration payload shape. [frontend/src/screens/history.py:88]
...
- 2026-06-03: Validation passed: `./.venv/bin/python -m unittest frontend.e2e.test_history_page.HistoryPageRenderingTests.test_history_page_renders_calibration_snapshot_from_backtest_feed -q`.
...
- 2026-06-03: Validation passed: `./.venv/bin/python -m unittest frontend.e2e.test_history_page -q`.
- 2026-06-03: Validation passed: `./.venv/bin/ruff check .`.
- 2026-06-03: Validation passed: `./.venv/bin/ruff format --check .`.
- 2026-06-03: Validation passed: `./.venv/bin/bandit -q services/backtesting_service.py services/feedback_service.py frontend/src/screens/history.py`.
...
- 2026-06-03: Validation passed after review fixes: `./.venv/bin/python -m unittest frontend.e2e.test_history_page -q`.
...
- 2026-06-03: Validation passed after review fixes: `./.venv/bin/bandit -q services/backtesting_service.py services/feedback_service.py frontend/src/screens/history.py models/repositories/settings.py`.
