...
- [x] [Review][Patch] [HIGH] Provide a pinned `merge_group` Action workflow example with generated-merge binding; the current pull-request-only example cannot serve as the documented merge-queue fallback. [docs/github-app.md:64]
