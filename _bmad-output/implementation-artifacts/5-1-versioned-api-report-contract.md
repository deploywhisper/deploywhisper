...
- UI validation not applicable: no UI route, retired Python UI component, rendered report/history/dashboard surface, browser interaction, keyboard behavior, or accessibility semantics changed.
