...
- **UI validation omissions:** Missing Playwright/browser validation task for stories that change React routes, UI primitives, rendered report/history/dashboard/settings/skills surfaces, browser interactions, keyboard behavior, or accessibility semantics
