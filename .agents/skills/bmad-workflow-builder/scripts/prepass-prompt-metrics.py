...
WASTE_PATTERNS = [
    ...
    (
        r"\b[Ll]et'?s (?:think about|begin|start)\b",
        "filler",
        'Filler: "let\'s think/begin"',
    ),
...
BACKREF_PATTERNS = [
    ...
    (
        ...
        'Back-reference: "as mentioned above/in/earlier"',
    ),
...
def scan_prompt_metrics(skill_path: Path) -> dict:
    ...
    return {
        ...
        "skill_md_summary": {
            ...
            "overview_lines": skill_md_data.get("overview_lines", 0)
            if skill_md_data
            else 0,
            ...
            "fenced_block_count": skill_md_data["fenced_block_count"]
            if skill_md_data
            else 0,
            "fenced_block_lines": skill_md_data["fenced_block_lines"]
            if skill_md_data
            else 0,
